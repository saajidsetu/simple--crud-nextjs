            ...
            <Fragment>
                {user._id !== userInfo?.user?._id && (
                    <>
                        ...
                        <Button variant="outlined" color="primary" onClick={() => setShowStatusPrompt(true)} sx={{ marginLeft: '5px' }}>
                            {user.active === 'Active' ? 'Disable' : 'Enable'}
                        </Button>
                        <Button variant="outlined" color="error" onClick={() => setShowDeletePrompt(true)} sx={{ marginLeft: '5px' }}>
                            Delete
                        </Button>
                    </>
                )}
                ...
                <AgreementModal
                    ...
                    onAgree={() =>
                        handleAgreeToDeactivate(user._id, user.name, user.email, user.username, user.role, user.active)
                    }
                />
            </Fragment>
        ),
