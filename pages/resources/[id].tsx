...
import { getSingleResourceFromAPI, updateResourcefromAPI, getPermalinkFromAPI } from '../../api_calls/resources.api';
import PrivateRoute from '../../components/auth/PrivateRoute';
import TextInput from '../../components/form/TextInput';
import Spinner from '../../components/helpers/Spinner';
import resourcesValidator, { iResource } from '../../components/validators/resources.validator';
                ...
                {loading ? (
                    ...
                    >
                        {(formProps: any) => {
                            return (
                                <Form>
                                    <Typography variant="h4">Update Resource Info</Typography>
                                    <TextInput
                                        field_name="name"
                                        label="Resource Name"
                                        formProps={formProps}
