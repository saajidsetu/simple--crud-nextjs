...
import { deleteReceiptFromAPI, getAllReceiptsFromAPI, iAPIReceipt } from '../../api_calls/receipts.api';
...
const ReceiptPage = () => {
    ...
    const columns = [
        { name: 'rate', label: 'Vehicle Rate Title', options: {
            filter: true,
            sort: true,
        ...
        rate:receipt.rate,
        date: formatDateToLocal({ oldDate: new Date(receipt.createdAt), dateTime: false }),
        actions: (
            <Fragment>
