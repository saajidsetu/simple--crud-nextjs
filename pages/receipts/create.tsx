...
import { Box, Button, Card, Typography, TextField, Grid, CardContent,RadioGroup, FormControlLabel, Radio } from '@mui/material';
...
import { initialReceipt, createReceiptSchema, iReceipt } from '../../components/validators/receipts.validator';
...
const CreateReceiptPage = () => {
    ...
    useEffect(() => {
        const getRates = async () => {
            ...
            const mapped = rates.map(rate => rate.name)
                                    ...
                                    return (
                                        <Form>
                                            <FormControl sx={{ margin: '20px 0px 20px 0px' }} fullWidth>
                                                <InputLabel id="demo-simple-select-label">Main Categories</InputLabel>
                                                <Select
