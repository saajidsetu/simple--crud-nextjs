...
import receiptsValidator, { iReceipt, initialReceipt, updateReceiptSchema } from '../../../components/validators/receipts.validator';
...
const SingleReceiptPage = () => {
    ...
    const [initialReceipt, setinitialReceipt] = useState(receiptsValidator.initialReceipt);
                   ...
                   {loading ? (
                    ...
                    >
                        {(formProps: any) => {
                            return (
                                <Form>
                                    <Typography variant="h4">Update Receipt Info</Typography>
