...
import { deleteCategorieFromAPI, getAllCategoriesFromAPI, iAPICategorie } from '../../api_calls/categories.api';
...
const CategoriePage = () => {
    ...
    const columns = [
        { name: 'name', label: 'Categorie Title', options: {
            filter: true,
            sort: true,
    ...
    const tableData = categorieList.map((categorie, user) => ({
        ...
        date: formatDateToLocal({ oldDate: new Date(categorie.createdAt), dateTime: false }),
        actions: (
            <Fragment>
