...
export const tryLogin = async (username: string, password: string, router: NextRouter, redirectUrl: string) => {
    try {
...
export const tryRegister = async (data: iRegister): Promise<BASIC_RETURN_TYPE> => {
