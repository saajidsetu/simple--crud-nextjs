...
exports.signupValidSchema = [
    (0, express_validator_1.body)('name', 'First name is required').isString(),
    ...
    (0, express_validator_1.body)('password', 'Password must be at least 6 characters').isLength({ min: 5 }),
];
